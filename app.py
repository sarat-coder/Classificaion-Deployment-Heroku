...
# Deployment part -process of transferting local host to cloud
clApp = ClientApp()

if __name__ == "__main__":
    # clApp = ClientApp()
    # app.run(host='0.0.0.0', port=port)
    app.run(debug=True) # by default port =5000 we can change port by mentioning port=8000 with comma.
